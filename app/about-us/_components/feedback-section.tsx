      ...
      <div className="md:w-5/6 md:mx-auto bg-[#ffedec] md:rounded-[80px] px-10 md:p-20 items-center justify-center py-10">
        <div className="md:flex">
          ...
          <div className="text-xl md:text-3xl text-[#92312a] leading-relaxed font-light justify-start items-start flex md:w-2/5 mx-auto">
            We value your feedback! We&apos;ve made providing feedback a fun and
            interactive experience. Our intuitive feedback system ensures your
            voice is heard and encourages continuous improvement across our
            platform. Your insights drive our evolution.
          </div>
        </div>

            ...
            <div className="md:ml-20 md:w-1/3">
              <div className="flex flex-col md:flex-row gap-6">
                <div className="w-full md:w-96">
                  ...
                  <div className="text-xl text-[#3d2e7c] leading-10 font-light pt-6">
                    Access an extensive library of educational materials,
                    carefully curated to support various learning needs. From
                    STEM subjects to humanities, our collection ensures a

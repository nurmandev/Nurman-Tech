      ...
      <div className="md:flex md:space-y-0 space-y-10 md:space-x-40">
        <div className="flex items-center justify-center flex-col">
          <div className="flex items-center justify-center">
            ...
            <div className="text-5xl font-medium md:text-[100px]">100%</div>
          </div>

          <div className="py-4">Support</div>
        ...
        <div className="flex items-center justify-center flex-col">
          <div className="flex items-center justify-center">
            ...
            <div className="text-5xl font-medium md:text-[100px]">24/7</div>
          </div>

          <div className="py-4">Customer Services</div>

...
import { Info, MessageCircleIcon, PhoneCall, Share, Smile } from "lucide-react";
...
const FormSchema = z.object({
  ...
  help: z.enum([
    "Evaluate Nurman for my company",
    "Learn More",
    "Get a Quote",
    "How to use Nurman",
    "Other",
        ...
        <div className="md:w-1/3 font-medium px-10">
          ...
          <div
            className="
                    ...
                    "
          >
            Whether you have questions, ideas, or you&apos;re ready to embark on
            a project together, We are here to help. Feel free to reach out
          ...
          <div className="flex flex-col space-y-6 pb-20">
            ...
            <div className="flex gap-6 items-center">
              <div className="bg-[#eff0ff] p-4 items-center justify-center flex rounded-full">
                <Info className="text-4xl text-[#4b42ad]" />
              </div>
              <div className="md:text-xl text-[#eff0ff] font-light">
                Need help from Nurman Innovation support representative?
                We&apos;re here for you.
              </div>
            </div>
          ...
          >
              ...
              render={({ field }) => (
                <FormItem className="items-center justify-center space-y-4 w-full">
                  ...
                  >
                    ...
                    <SelectContent>
                      <div className="flex gap-4">
                        <SelectItem value="Evaluate Nurman for my company">
                          Evaluate Nurman for my company
                        </SelectItem>
                      </div>
            ...
            <div className="flex gap-4 items-center">
              ...
              <div className="text-md font-light text-[#6c6684] md:w-3/4 mb-1">
                I agree to Nurman&apos;s Terms of Service and Privacy Policy.
              </div>
            </div>

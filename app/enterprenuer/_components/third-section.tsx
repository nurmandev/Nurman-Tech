              ...
              md:text-3xl
               font-light
                ...
                flex
                 justify-center"
        >
          We&apos;ve added 500+ learning opportunities to create one of the
          world&apos;s most comprehensive free-to-degree online learning
          platforms.
        </div>
      </div>
                ...
                <div className="flex space-x-10 w-full">
                  ...
                  <div>
                    ...
                    <div className="text-lg text-[#3d2e7c] md:leading-10 font-light w-5/6 py-4">
                      Expert-led, fully supported courses that build

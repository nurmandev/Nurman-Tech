            ...
            >
              <div className="md:space-y-10 flex flex-col px-4 py-10">
                ...
                <div className="text-5xl md:text-7xl pb-4 md:pb-0">
                  Best practice learning from a credible network
                </div>
                <div className="text-xl md:text-3xl w-5/6">
                  Imagine having a learning experience designed just for you! In
                  the future, credible networks will use AI to understand
                  exactly how you learn best, tailoring content to match your
                ...
                <div className="md:flex pt-10 md:py-10">
                  <div className="space-y-10">
                    <div className="flex items-center gap-4">
                      ...
                      <span className="text-xl">Collaborative</span>
                    </div>
                  ...
                  <div className="space-y-10 py-10 md:py-0 md:ml-40">
                    ...
                    <div className="flex items-center gap-4">
                      <Check className="text-3xl text-indigo-500" />
                      <span className="text-xl">Inclusive Learning</span>
                    </div>

  ...
  const renderContent = () => {
    switch (activeTitle) {
      case "Titles":
        return (
          <div className="md:py-8">
            <h2 className="py-10 text-3xl font-medium">Save Time</h2>
            <p className="text-3xl leading-relax text-[#3d2e7c] font-light">
              No more hours spent curating content—get your CMS website
              instantly.Manage, and Secure Your Content Instantly!
            </p>
          </div>
        );
      ...
      case "Summaries":
        return (
          <div className="md:py-8">
            ...
            <p className="text-3xl leading-relax text-[#3d2e7c] font-light">
              Welcome to Nurman AI, where the power to create, manage, and
              safeguard learning content resides at your fingertips. Our
              AI-driven platform offers the unique ability to generate
              personalized learning websites and effortlessly manage every piece
              of content—all while ensuring top-notch encryption for maximum
              data security.
            </p>
          </div>
        );
      ...
      case "Chapters":
        return (
          <div className="md:py-8">
            <h2 className="py-10 text-3xl font-medium">Accessible Anywhere</h2>
            <p className="text-3xl leading-relax text-[#3d2e7c] font-light">
              Access your learning site from any device, anytime.
            </p>
          </div>
        );
      ...
      case "Tasks":
        return (
          <div className="md:py-8">
            ...
            <p className="text-3xl leading-relax text-[#3d2e7c] font-light">
              Easily modify, add, or remove content to suit your evolving needs.
            </p>
          </div>
        );
      default:
    ...
    <>
      ...
      <div className="md:hidden bg-[#eff0ff]">
        <div className="px-10">
          <div className="md:hidden pt-6">
            ...
            <div className="leading-relaxed text-[#3d2e7c] font-light">
              No more hours spent curating content—get a website instantly.
            </div>
          </div>
        </div>
        ...
        <div className="px-10">
          <div className="md:hidden pt-6">
            <Image
              src="/Ai-images/AI-generated-3D.png"
              alt="image"
              width={1920}
              height={1080}
              className="p-10"
            ...
            <div className="leading-relaxed text-[#3d2e7c] font-light">
              Enjoy content tailored specifically to your preferences and needs.
            </div>
          </div>
        </div>
        ...
        <div className="px-10">
          <div className="md:hidden pt-6">
            <Image
              src="/Ai-images/AI_600_x_400.png"
              alt="image"
              width={1920}
              height={1080}
              className="p-10"

  ...
  return (
    <div className="md:py-40 bg-[#eff0ff]">
      <div className="flex flex-col justify-center space-y-4">
        ...
        Empower Your Learning Journey Effortlessly
        </div>
        <p
          className="
            text-xl
            ...
            "
        >
          Instantly Create Tailored Learning Websites with AI - One Click Away!
        </p>
          ...
          <div className="flex">
            ...
            >
              <div className="flex items-center justify-center">
                <div className="text-lg py-4 md:py-0">Generate Nurman AI</div>
              </div>
            </div>
          </div>
        </div>
